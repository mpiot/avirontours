...
/**
 * The three panels of a phase stack up and only the last one draws the time axis, so they have to
...
export default class extends Controller {
    ...
    _onPreConnect (event) {
        ...
        // Before the early return: every panel is pinned, or the ones that are not drift again.
