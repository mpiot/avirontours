...
class ShellDamageCategoryControllerTest extends AppWebTestCase
{
    ...
    {
        $client = static::createClient();
        $url = '/shell-damage-category/1/edit';
    ...
    {
        $client = static::createClient();
        $url = '/shell-damage-category/3/edit';
        ...
        $this->assertResponseRedirects('/shell-damage-category/');
