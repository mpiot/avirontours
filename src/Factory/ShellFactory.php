 ...
 * @method static          Shell|Proxy random()
 * @method static          Shell[]|Proxy[] randomSet(int $number)
 * @method static          Shell[]|Proxy[] randomRange(int $min, int $max)
 * @method static          ShellRepository|RepositoryProxy repository()
 * @method Shell|Proxy     create($attributes = [])
 * @method Shell[]|Proxy[] createMany(int $number, $attributes = [])
 */
