 ...
 * @method static                       MedicalCertificate|Proxy random()
 * @method static                       MedicalCertificate[]|Proxy[] randomSet(int $number)
 * @method static                       MedicalCertificate[]|Proxy[] randomRange(int $min, int $max)
 * @method static                       MedicalCertificateRepository|RepositoryProxy repository()
 * @method MedicalCertificate|Proxy     create($attributes = [])
 * @method MedicalCertificate[]|Proxy[] createMany(int $number, $attributes = [])
 */
