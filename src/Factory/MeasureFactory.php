...
final class MeasureFactory extends PersistentProxyObjectFactory
{
    ...
    protected function defaults(): array|callable
    {
        return [
            ...
            'measuredAt' => \DateTimeImmutable::createFromMutable(self::faker()->dateTime()),
            'type' => self::faker()->randomElement(MeasureType::cases()),
    ...
    {
        return $this
            // ->afterInstantiate(function(Measure $measure): void {})
        ;
    }
