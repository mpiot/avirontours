...
class Training
{
    ...
    public const string TYPE_B1 = 'b1';
    public const string TYPE_B2 = 'b2';
    public const string TYPE_B3 = 'b3';
    public const string TYPE_B4 = 'b4';
    public const string TYPE_B5 = 'b5';
    public const string TYPE_B6 = 'b6';
    public const string TYPE_B7 = 'b7';
    public const string TYPE_B8 = 'b8';
    public const string TYPE_C1 = 'c1';
    public const string TYPE_C2 = 'c2';
    public const string TYPE_REST = 'rest';
    public const string TYPE_GENERALIZED_ENDURANCE = 'generalized_endurance';
    public const string TYPE_SPLIT_SHORT = 'split_short';
    public const string TYPE_SPLIT_LONG = 'split_long';
    public const string ENERGY_PATHWAY_AEROBIC = 'aerobic';
    public const string ENERGY_PATHWAY_THRESHOLD = 'threshold';
    public const string ENERGY_PATHWAY_LACTIC_ANAEROBIC = 'lactic_aerobic';
    public const string ENERGY_PATHWAY_ALACTIC_ANAEROBIC = 'alactic_aerobic';
    public const string SPORT_OTHER = 'other';
    public const string SPORT_ROWING = 'rowing';
    public const string SPORT_RUNNING = 'running';
    public const string SPORT_ERGOMETER = 'ergometer';
    public const string SPORT_WORKOUT_ENDURANCE = 'workout_endurance';
    public const string SPORT_WORKOUT_STRENGTH = 'workout_strength';
    public const string SPORT_SWIMMING = 'swimming';
    public const string SPORT_GENERAL_PHYSICAL_PREPARATION = 'general_physical_preparation';
    public const string SPORT_STRENGTHENING = 'strengthening';
    public const string SPORT_CYCLING = 'cycling';
    public const string SPORT_YOGA = 'yoga';
